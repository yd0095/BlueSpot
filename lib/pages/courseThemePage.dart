...
class _CourseThemePageState extends State<CourseThemePage>{
  ...
  final courseTheme = ['데이트 코스', '먹방 코스', '오락 코스','힐링 코스','추억여행 코스','운동 코스','쇼핑 코스','대학가 주변 코스','유명지 코스' ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: Text('관심 코스 테마 설정', style: TextStyle(
              ...
              child: new Column(
                children: <Widget>[
                  new CheckboxListTile(
                      value: check[index],
                      title: new Text('${courseTheme[index]}', style: GoogleFonts.inter(
                        fontSize: 17,
                        fontWeight: FontWeight.bold,
                      )),
                      controlAffinity: ListTileControlAffinity.trailing,
                      onChanged: (bool val){checkChange(val,index);}),
