...
class SpotPage3 extends StatefulWidget {
  final String uid;
  final User loggeduser;
  final String marker_id;

  SpotPage3({Key key, @required this.uid, this.loggeduser,this.marker_id}) : super(key: key);

  @override
  _SpotPage3State createState() => _SpotPage3State(uid, loggeduser, marker_id);
}

class _SpotPage3State extends State<SpotPage3> {
  ...
  final User loggeduser;
  final String marker_id;
  _SpotPage3State(this.uid, this.loggeduser, this.marker_id);
            ...
            leading: IconButton(
              ...
              onPressed: () {
                ...
                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) =>
                    MyPage(uid: this.uid,loggeduser: this.loggeduser,)));
              },
            ),
